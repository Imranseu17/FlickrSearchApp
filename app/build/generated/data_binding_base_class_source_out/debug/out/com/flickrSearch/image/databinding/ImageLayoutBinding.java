...
public final class ImageLayoutBinding implements ViewBinding {
  ...
  private ImageLayoutBinding(@NonNull LinearLayout rootView, @NonNull ImageView imageViewMain) {
  ...
  public static ImageLayoutBinding bind(@NonNull View rootView) {
    ...
    missingId: {
      ...
      return new ImageLayoutBinding((LinearLayout) rootView, imageViewMain);
    }
