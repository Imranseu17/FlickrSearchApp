...
public abstract class Hilt_PhotosearchFragment extends Fragment implements GeneratedComponentManager<Object> {
  ...
  Hilt_PhotosearchFragment() {
    super();
  }

  Hilt_PhotosearchFragment(int contentLayoutId) {
  ...
  public final Object generatedComponent() {
    return UnsafeCasts.<Hilt_PhotosearchFragment>unsafeCast(this).componentManager().generatedComponent();
  }
  ...
  protected void inject() {
    ((PhotosearchFragment_GeneratedInjector) UnsafeCasts.<Hilt_PhotosearchFragment>unsafeCast(this).generatedComponent()).injectPhotosearchFragment(UnsafeCasts.<PhotosearchFragment>unsafeCast(this));
  }
