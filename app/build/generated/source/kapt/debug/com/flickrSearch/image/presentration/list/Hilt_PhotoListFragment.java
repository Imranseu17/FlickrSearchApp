...
public abstract class Hilt_PhotoListFragment extends Fragment implements GeneratedComponentManager<Object> {
  ...
  Hilt_PhotoListFragment() {
    super();
  }

  Hilt_PhotoListFragment(int contentLayoutId) {
  ...
  public final Object generatedComponent() {
    return UnsafeCasts.<Hilt_PhotoListFragment>unsafeCast(this).componentManager().generatedComponent();
  }
  ...
  protected void inject() {
    ((PhotoListFragment_GeneratedInjector) UnsafeCasts.<Hilt_PhotoListFragment>unsafeCast(this).generatedComponent()).injectPhotoListFragment(UnsafeCasts.<PhotoListFragment>unsafeCast(this));
  }
